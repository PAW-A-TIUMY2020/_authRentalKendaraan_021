...
{
    public partial class RentalKendaraannContext : IdentityDbContext
    {
        public RentalKendaraannContext()
        {
        }

        public RentalKendaraannContext(DbContextOptions<RentalKendaraannContext> options)
            : base(options)
        {
        }
